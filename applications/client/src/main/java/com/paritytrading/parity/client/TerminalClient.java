...
class TerminalClient implements Closeable {
	...
	private TerminalClient(Events events, OrderEntry orderEntry, Instruments instruments, String username) {
        this.events      = events;
    ...
    static TerminalClient open(InetSocketAddress address, String username,
        ...
        return new TerminalClient(events, orderEntry, instruments, username);
    }
